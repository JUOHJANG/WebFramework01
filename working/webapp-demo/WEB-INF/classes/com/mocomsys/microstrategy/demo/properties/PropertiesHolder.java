package com.mocomsys.microstrategy.demo.properties;
...
public class PropertiesHolder<T> {
	...
	public void load() { properties = loader.load(); }
	...
	public String getString(final String pid) {
		...
		if (properties != null) { result = properties.getProperty(pid, defaultValue); }
