...
abstract public class ConfigHandler {
	...
	protected final void setParam(Map<String, Object> param) { this.param = param; }
	
	protected final Map<String, Object> getParam() { return param; }
	...
	protected final void setConfigObjectList(List<Map<String, Object>> configObjectList) { this.configObjectList = configObjectList; } 
	
	protected final List<Map<String, Object>> getConfigObjectList() { return configObjectList; }
