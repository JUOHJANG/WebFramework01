...
public class PromptCharger {
	...
	*/
		...
		private static PromptDao getPromptDao(ObjectConfig config) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, WebObjectsException {
			PromptDao dao = null;
			
			Map<String, Object> elementSource = null;
			if (config != null) { elementSource = config.<Map<String, Object>>get("elementSource"); }
			
			if (elementSource != null) {
				String daoClassName = (String)elementSource.get("className");
				
				Class<CustomPromptDao<?, ?>> clazz = (Class<CustomPromptDao<?, ?>>)PromptCharger.class.getClassLoader().loadClass(daoClassName);
				...
				if (matchConstructor != null) { dao = matchConstructor.newInstance(param1, param2); }
			}
			
			return dao;
		}

		private static PromptDao getPromptDao(WebIServerSession session, WebPrompt webPrompt, ObjectConfig config) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, WebObjectsException {
		...
		private static void chargeElement(Prompt prompt, PromptDao dao) {
			if (dao != null) {
				...
				prompt.setControlType(dao.getDefaultAnswer());
		...
		public static final Prompt getChargedPrompt(WebIServerSession session, WebPrompt webPrompt, ObjectConfig config) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, WebObjectsException {
		...
		public static final Prompt getChargedPrompt(ObjectConfig config) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, WebObjectsException {
	...
	/*
	public static final PromptDao getPromptDao(WebIServerSession session, WebPrompt webPrompt) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, WebObjectsException {
		return getPromptDao(session, webPrompt, ConfigManager.getInstance().getObjectConfig(webPrompt));
	}
	
	public static final PromptDao getPromptDao(String project, String id) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, WebObjectsException {
		return getPromptDao(ConfigManager.getInstance().getObjectConfig(project, id));
	}
	*/
 		
	public static final Prompt getChargedPrompt(WebIServerSession session, WebPrompt webPrompt) throws WebObjectsException, IllegalArgumentException, ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, InvocationTargetException {
		String cacheItemId = CacheManager.getCacheItemId(CacheObjectType.PROMPT, session.getProjectID(), webPrompt.getID());
	 ...
	 * @throws Exception
	 */
	public static final Prompt getChargedPrompt(String project, String promptId) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, WebObjectsException {
	...
	public static final <T1, T2> T2 getClientResponse(WebIServerSession session, String project, String promptId, T1 t1) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, WebObjectsException {
		String cacheItemId = CacheManager.getCacheItemId(CacheObjectType.PROMPT, project, promptId);
		ObjectConfig objectConfig = CacheManager.<ObjectConfig>getCache(cacheItemId);
		
		if (objectConfig == null) { objectConfig = ConfigManager.getInstance().getObjectConfig(project, promptId); }
		...
		if (promptDao == null) {
			WebPrompt prompt = (WebPrompt)session.getFactory().getObjectSource().getObject(promptId, EnumDSSXMLObjectTypes.DssXmlTypePrompt, true);
