...
public class JsonConfigHandler extends ConfigHandler {
	...
	/* (non-Javadoc)
	 * @see com.mocomsys.microstrategy.sdk.config.ConfigHandler#initConfigObjectList()
	 */
	@Override
	public void initConfigObjectList() {
		...
		try {
			...
			List<Map<String, Object>> configObjectList = new ObjectMapper().readValue(reader, new TypeReference<List<Map<String, Object>>>() {}); 
	...
	/* (non-Javadoc)
	 * @see com.mocomsys.microstrategy.sdk.config.ConfigHandler#getObjectConfig(java.lang.String, java.lang.String)
	 */
	@Override
	public ObjectConfig getObjectConfig(String project, String objectId) {
		...
		if (list != null) {
			for (Map<String, Object> map : list) {
				if (
						StringUtils.equals((String)map.get("objectId"), objectId) &&
						(StringUtils.equals("*",  (String)map.get("project")) || StringUtils.equals(project, (String)map.get("project")))
						) {
					match = map;
				}
			}
	...
	/* (non-Javadoc)
	 * @see com.mocomsys.microstrategy.sdk.config.ConfigHandler#getObjectConfig(com.microstrategy.web.objects.WebObjectInfo)
	 */
	@Override
