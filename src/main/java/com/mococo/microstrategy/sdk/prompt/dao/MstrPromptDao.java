...
public class MstrPromptDao<T extends WebPrompt> implements PromptDao {
	...
	protected MstrPromptDao(T webPrompt) { 
		if (webPrompt == null) { throw new SdkRuntimeException("Prompt is null."); }
	...
	public T getPrompt() { return webPrompt; }
	
	@Override
	public int getPin() { return webPrompt.getPIN(); }
	
	@Override
	public String getMin() { return webPrompt.getMin(); }
	
	@Override
	public String getMax() { return webPrompt.getMax(); }
	...
	public boolean isSingle() {
		...
		try {
			property = webPrompt.getPropertySets().getItemByName("WebProperties").getItemByName("PSXSL").getValue().toLowerCase();
		} catch (IllegalArgumentException | WebObjectsException e) {
			logger.error("!!! get prompt[{}] property error", webPrompt, e);
		}
		
		return (StringUtils.isNotEmpty(property) && property.matches("promptelement_pulldown.xsl|promptelement_radio.xsl|promptelement_singleselect_listbox.xsl"));
	}

	@Override
	public boolean isRequired() { return webPrompt.isRequired(); }
    
	@Override
	public String getDefaultAnswer() { return null; }
	
	@Override
	public List<PromptElement> getDefaultAnswers() { return null; }
	
	@Override
	public List<PromptElement> getSuggestedAnswers() { return null; }
	
	@Override
	public List<PromptElement> getSuggestedAnswers(int level, String selectedElemId) { return null; }
