...
public class MstrUserUtil {
	 ...
	 * @throws WebBeanException
	 */
	public static final WebUser createUserWithMail(WebIServerSession session, String userId, String name, String pwd, String email, String deviceId) throws WebObjectsException, WebBeanException {
		UserBean userBean = (UserBean)BeanFactory.getInstance().newBean("UserBean");
		userBean.setSessionInfo(session);
		userBean.InitAsNew();
	 ...
	 * @throws WebObjectsException
	 */
	public static final WebUserGroup createUserGroup(WebIServerSession session, String userGroupName, String parentObjectId, String desc) throws WebBeanException, WebObjectsException {
	...
	public static final WebUserGroup getUserGroup(WebObjectSource objectSource, String userGroupObjectId) throws WebObjectsException {
		WebUserGroup user = (WebUserGroup)objectSource.getObject(userGroupObjectId, EnumDSSXMLObjectTypes.DssXmlTypeUser, EnumDSSXMLObjectSubTypes.DssXmlSubTypeUserGroup, true);		
	...
	public static final List<String> getUserGroupIdList(WebUser user) {
		...
		if (user != null) {
            ...
            for (Enumeration<WebObjectInfo> e = userList.elements(); e.hasMoreElements();) {
                ...
                if (info.getSubType() != EnumDSSXMLObjectSubTypes.DssXmlSubTypeUserGroup) { continue; }
	...
	public static final void addToUserGroup(WebObjectSource objectSource, WebUser user, String userGroupObjectId) throws WebObjectsException {
		WebUserGroup userGroup = (WebUserGroup)objectSource.getObject(userGroupObjectId, EnumDSSXMLObjectTypes.DssXmlTypeUser, EnumDSSXMLObjectSubTypes.DssXmlSubTypeUserGroup, true);
	...
	/**
	 * 파라미터로 전달된 오브젝트ID를 갖는 사용자그룹의 하위 사용자그룹, 사용자 정보를
	 * 사용자그룹명/사용자그룹 오브젝트ID로 구성된 맵, 사용자ID/사용자 오브젝트ID로 구성된 맵, 사용자그룸명/소속 사용자 오브젝트ID 리스스로 구성된 맵을 반환 
	 * @param source
	 ...
	 * @throws WebObjectsException 
	 */
	public static Map<String, Map<String, ?>> getSubUserObject(WebObjectSource source, String baseMstrGroupId) throws WebObjectsException, IllegalArgumentException {
	...
	/**
	 * 파라미터로 전달된 오브젝트ID를 갖는 사용자그룹의 하위 사용자그룹, 사용자 정보를
	 * 사용자그룹명/사용자그룹 오브젝트ID로 구성된 맵을 반환 
	 * @param source
	 * @param baseMstrGroupId
	 * @return
	 * @throws IllegalArgumentException 
	 * @throws WebObjectsException 
	 */
	public static Map<String, String> getSubUserGroup(WebObjectSource source, String baseMstrGroupId) throws WebObjectsException, IllegalArgumentException {
		Map<String, String> mstrGroupMap = new HashMap<String, String>();
