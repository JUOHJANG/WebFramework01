...
public class DemoServiceImpl implements DemoService {
	@Autowired SimpleBizDao simpleBizDao;
	...
	public void errorInMultiInsert(List<Map<String, Object>> param) {
		...
		for (Map<String, Object> map : param) {
			...
			if (StringUtils.equals((String)map.get("dummy"), "오류데이터")) { throw new RuntimeException("!!! '오류데이터'가 포함되었습니다."); }
		}
	}
	...
	public void dummyBatchUpdate(List<Map<String, Object>> param) {
		...
		template.batchUpdate(
			"INSERT INTO dbo.DUMMY (DUMMY) VALUES (?)",
			new BatchPreparedStatementSetter() {
				...
				public void setValues(PreparedStatement statement, int i) throws SQLException {
					...
					if (StringUtils.equals(data, "오류데이터")) { throw new RuntimeException("!!! '오류데이터'가 포함되었습니다."); }
				}
				@Override
