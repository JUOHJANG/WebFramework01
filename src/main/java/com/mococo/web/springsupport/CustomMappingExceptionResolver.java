...
public class CustomMappingExceptionResolver extends SimpleMappingExceptionResolver implements MessageSourceAware {
	...
	public void setDefaultCode(final String defaultCode) { this.defaultCode = defaultCode; }
	public String getDefaultCode() { return this.defaultCode; }
	...
	protected ModelAndView doResolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) {
		...
		if (!HttpUtil.isJsonRequest(request)) { return super.doResolveException(request, response, handler, ex); }
